package com.mbirr.paymentGW.servlet;
...
//import java.util.Timer;
/**
 * Servlet implementation class ClientServlett
 */
public class ClientServlett extends HttpServlet {
...
//		int countr = CL.get(0).getCouter();
		...
		String req = "<TransferRequest><phone>" + phone + "</phone><receiver>" + receiver + "</receiver><amount>" + amount + "</amount></TransferRequest>";
